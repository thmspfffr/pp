...
for ifoi = [5 11 14 22]
  ...
  print(gcf,'-dpdf',sprintf('~/pp/plots/pp_figure6_dt0_f%d_v%d.tiff',ifoi,v))
...
for ifoi = [5 11 14 22]
  ...
  set(gcf,'renderer','painters')
  print(gcf,'-dpdf',sprintf('~/pp/plots/pp_figure6_dt1_f%d_v%d.tiff',ifoi,v))
