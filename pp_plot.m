...
[plt_gla,plt_hh,plt_mue,plt_all1]=pp_load_results(1);
[plt_gla,plt_hh,plt_mue,plt_all2]=pp_load_results(2);
...
for ifoi = [5 11 14 22]
  ...
  text(1,1,sprintf('[%.3f %.3f]\n [%.3f Hz]\nAdjP =%.4f',clim(1),clim(2),ifoi,fdr1(p(:),0.1,0)))  
...
for ifoi = [11 14]
  ...
  text(1,1,sprintf('[%.8f %.3f]\n [%.8f Hz]\n PAdj = %.4f',para.colorlimits(1),para.colorlimits(2),ifoi,fdr1(p(:),0.1,0)))
